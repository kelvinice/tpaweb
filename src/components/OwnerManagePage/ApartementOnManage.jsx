...
class ApartementOnManage extends Component {
    sisaKamarHandler(){
        if (this.props.data.unit===0){
            return <span style={{fontWeight:"bold",color:"gray"}}>Unit tidak tersedia</span>
        }else if (this.props.data.unit===1){
            return <span style={{fontWeight:"bold",color:"red"}}>Tinggal 1 unit</span>
        }else{
            return <span style={{fontWeight:"bold",color:"#00d91f"}}>Ada {this.props.data.unit} unit</span>
        }
    }
            ...
            <AllWrapper>
                <AttributeContainer>
                    ...
                    <TextWrapper>
                        ...
                        <div>{this.props.data.floor} lantai</div>
                    </TextWrapper>
                </AttributeContainer>
                <ButtonWrapper>
                    <ButtonBan ><FontAwesomeIcon icon={faRedoAlt}/></ButtonBan>
                    <ButtonDelete onClick={(target)=>this.props.setTarget({apartement:this.props.data,type:"delete"})}><FontAwesomeIcon icon={faTrashAlt}/></ButtonDelete>
                </ButtonWrapper>
            </AllWrapper>
        );
    }
...
export default ApartementOnManage;